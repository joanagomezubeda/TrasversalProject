...
<?php else:?>
    <div class="me-3 mt-4">
        <div class="bg-color p-3 rounded-4 shadow ">
            <h3 class="fw-bold">Want to borrow books?</h3>
            <p>Log in now to ask other users about their books.</p>
            <a class="btn btn-primary-color col-xl-3 col-md-12 col-12" href="<?php ROOT_URL?>users/login">Log In to Borrow</a>
        </div>
    </div>
<?php endif;?>
