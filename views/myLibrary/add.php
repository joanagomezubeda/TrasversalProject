...
<div class="d-flex flex-column flex-lg-row text-justify justify-content-center mt-4">
    <div class="col-sm-12 col-md-12 col-lg-10 col-xl-8 mt-sm-5 mt-4 mt-lg-0  bg-color rounded-4 p-5 shadow">
        <h1 class="text-center mb-4 fw-bold">Add a book!</h1>
        <form action="<?php $_SERVER['PHP_SELF']?>" method="post" class="" enctype="multipart/form-data">
            ...
            <div class="form-group mt-3 d-flex flex-column flex-xl-row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                    ...
                    <input type="text" placeholder="The little Prince" name="title" class="form-control form-border" id="title" required>
                </div>
                <!-- Author -->
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 mt-3 mt-xl-0">
                    <label for="author">Author</label>
                    <input type="text" placeholder="Antoine de Saint-Exupéry" name="author" class="form-control form-border" id="author" required>
                </div>
            </div>
            <!-- Editorial and Genre -->
            <div class="form-group mt-3 d-flex flex-column   flex-xl-row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 mt-3 mt-xl-0">
                    ...
                    <input type="text" placeholder="Wolfsong" class="form-control form-border" id="editorial" name="editorial" required>
                </div>
                <!-- Genre -->
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 mt-3 mt-lg-0">
                    <label for="genre">Genre</label>
                    <input type="text" placeholder="Fantasy" name="genre" class="form-control form-border" id="genre" required>
                </div>
            </div>
            <!-- Description -->
           <div class="mt-3">
               <label for="description">Description</label>
               <textarea name="description" id="description" cols="10" rows="5" class="form-border form-control" required></textarea>
           </div>
            ...
            <div class="mt-3">
                <button class="btn btn-primary-color w-100 mb-2" name="submit" type="submit" >Add the book</button>
            </div>
    </div>
</div>
