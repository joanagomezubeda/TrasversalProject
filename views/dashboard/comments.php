...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <th scope="col">ID_Publication</th>
        ...
        <?php foreach ($viewmodel as $item): ?>
            <tr>
                ...
                <td><?php echo $item['id_publication']?></td>
                <td>
                    <a class="btn btn-primary-outline col-12 col-md-12 col-lg-8 col-xl-5 mt-2" href="<?php echo ROOT_URL?>dashboard/editComment/<?php echo $item['ID']?>">Edit</a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a type="button" class="btn btn-primary-color" href="<?php echo ROOT_PATH; ?>dashboard/deleteComment/<?=$item['ID']?>">Delete</a>
                        </div>
                    </div>
                </div>
            </div>
