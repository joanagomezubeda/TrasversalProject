...
<div class="mt-5 d-flex justify-content-center">
    <div class="mx-5 d-flex justify-content-center pb-4 row col-12 col-xl-10 col-xxl-8 bg-color rounded-4">
        <div class=" py-5">
            ...
            <form action="<?php $_SERVER['PHP_SELF']?>" method="post" class="px-5">
                ...
                <div class="form-group mt-3 d-flex flex-column flex-xl-row">
                    ...
                    <div class="form-group col-12 mt-3 mt-xl-0 col-xl-6">
                        <label for="username">User name *</label>
                        <input type="text" placeholder="@jondoe" name="username" class="form-control form-border" id="username">
                    </div>
                </div>
                ...
                <div class="form-group d-flex flex-column flex-xl-row mt-3">
                    <div class="form-group col-12 col-lg-12 col-xl-6">
                        <label for="city">City</label>
                        <input type="text" placeholder="City" name="city" class="form-control form-border" id="city">
                    </div>
                    <div class="form-group col-12 col-lg-12 col-xl-6 mt-3 mt-xl-0">
